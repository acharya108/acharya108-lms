...
async def working_registration_test():
    print("🧪 Working Registration Test")
    print("=" * 40)
    ...
    try:
        ...
        inserted_id = await conn.fetchval("""
            INSERT INTO users (id, email, password, "updatedAt", "isConfirmed", role) 
            VALUES ($1, $2, $3, $4, $5, $6)
            RETURNING id
        """, user_id, test_email, "testpass123", current_time, False, "student")
...
asyncio.run(working_registration_test())